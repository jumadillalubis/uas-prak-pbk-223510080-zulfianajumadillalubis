<template>
    <div class="centered-content">
      <div class="weather-widget">
        <div class="widget-header">
          <h2 class="widget-title" style="color: #C0C0C0;">Informasi Cuaca</h2>
        </div>
        <q-input
          filled
          v-model="searchQuery"
  ...
  .weather-widget {
    ...
    background-image: url("https://i.pinimg.com/564x/7d/e3/65/7de3657b1a62131991d5f5123c323de9.jpg"); /* Ganti dengan URL gambar latar belakang yang valid */
